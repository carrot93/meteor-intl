(function() {
    ...
    var $$helpers$$Intl = (typeof $$helpers$$Intl === 'undefined') ? IntlPolyfill: $$helpers$$Intl;

    // -----------------------------------------------------------------------------

    var $$helpers$$getNumberFormat   = intl$format$cache$$default($$helpers$$Intl.NumberFormat);
    var $$helpers$$getDateTimeFormat = intl$format$cache$$default($$helpers$$Intl.DateTimeFormat);
    ...
    function $$helpers$$registerWith(Template) {
      ...
      function formatHTMLMessage() {
        ...
        for (key in hash) {
          if (hash.hasOwnProperty(key)) {
            ...
            if (typeof value === 'string') {
              hash[key] = $$helpers$$escapeExpression(value);
            }
          }
        }
        ...
        return new $$helpers$$SafeString(String(formatMessage.apply(this, arguments)));
      }
    ...
    var $$helpers$$badChars = /[&<>"'`]/g;
    var $$helpers$$possible = /[&<>"'`]/;

    function $$helpers$$escapeChar(chr) {
      return $$helpers$$escape[chr];
    }

    function $$helpers$$escapeExpression(string) {
